...
// Right-click menu, styled to match dropdown-menu.tsx (same Base UI menu
// parts under the hood, anchored to the pointer instead of a trigger).
    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          ...
          className={cn(POPUP_CLASS, "min-w-32 shadow-lg", className)}
          {...props}
        />
      </ContextMenuPrimitive.Positioner>
    </ContextMenuPrimitive.Portal>
